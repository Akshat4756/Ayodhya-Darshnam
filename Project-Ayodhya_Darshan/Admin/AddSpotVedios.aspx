<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddSpotVedios.aspx.cs" Inherits="Project_Ayodhya_Darshan.Admin.AddSpotVedios" %>
        ...
        <div class="container-fluid">
            ...
            <div class="box_general padding_bottom">
                <div class="header_box version_2">
                    <h2><i class="fa fa-file"></i>Add Spot Vedios</h2>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>Vedio Iitle :</label>
                            <asp:TextBox class="form-control" ID="txtVedioIitle" runat="server" placeholder="Name"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rqrVedioIitle" ControlToValidate="txtVedioIitle" Display="Dynamic" ErrorMessage="Please enter Vedio title" ForeColor="Red" ValidationGroup="combination" SetFocusOnError="True" />                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Spot Vedio URL</label>
                            <asp:FileUpload class="form-control" ID="SpotVedioURL" runat="server" placeholder="SpotVedio"></asp:FileUpload>
                            <asp:RequiredFieldValidator runat="server" ID="reqSpotVedioURL" ControlToValidate="SpotVedioURL" Display="Dynamic" ErrorMessage="Please enter Vedio URL" ForeColor="Red" ValidationGroup="combination" SetFocusOnError="True" />
                        </div>
                    </div>
                </div>
            ...
            <div class="box_general padding_bottom">
                <div class="header_box version_2">
                    <h2><i class="fa fa-file-text"></i>Spots Vedio List</h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
